...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;1,600&family=Raleway:wght@200&display=swap" rel="stylesheet"> 
    ...
    <link rel="stylesheet" href="Paginas/Es/immersive-sliderEn.css">
    ...
    <div class="HeaderContenedor">
       ...
       <!--  </div> -->
         ...
         <div class="contentSub"> 
            <p class="Subtitulo">Web Design/Web Programming/Junior </p>
            <h2 class="escritura"><span class="typed"></span></h2>
        </div> 

        <!-- <div class="contentBtn"> -->
            <a href="https://drive.google.com/file/d/1YaHQDVPZs37Yonc4EoEP1CWGeBnSIbix/view?usp=sharing" class="btn btonHV" target="_blank">DOWNLOAD CV</a>
        <!-- </div> -->
        </div>
...
<!--MENU-->
    <div class="sticky-sm-top"><?php include("Paginas/Es/MenuEn.php") ?></div>
    <!--fINALMENU-->
<section id="acercaDemi">
<!--Info-->

<?php include("Paginas/Es/infoEn.php") ?>   
<div>
...
<?php include("Paginas/Es/resumenEn.php") ?>   
</section>

<section id="Portafolio">
    
    <?php include("Paginas/Es/demoEn.html") ?>
</section>
            ...
            <div class="col-sm-12 col-md-12 col-lg-10 contenedorContacto">
                     <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 contenedorContactos">
                            <?php include("Paginas/Es/formularioEn.html") ?>
                        </div>                       
                     </div>   
...
<section>
    <?php include("Paginas/Es/footerEn.php") ?>
</section>
...
<!--Carousel-->
<script src="Paginas/Es/jquery.immersive-sliderEn.js"></script>
...
<script src="web/js/mainEs.js"></script>
</body>
<!--icono carga-->
<script>
...
<!--Animaciones-->
   ...
   <script src="web/js/prueba.js"></script>
</html>